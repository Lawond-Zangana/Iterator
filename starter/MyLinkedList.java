    ...
    //Beginning of PA4
     protected class MyListIterator implements ListIterator<E> {
        ...
        public E next(){
            ...
            //throw if there is no element after
            if(hasNext() == false) {
            throw new NoSuchElementException(); 
             }

            //Change the location of the left and right pointers in the iterator
            left = right; 
            right = left.next;
            //Update the variables that need to be updated
            canRemoveOrSet = true;
            idx++; 
            forward = true; 
        ...
        public E previous(){
            ...
            //throw if there is no element before
        ...
        public int nextIndex(){
            ...
            //If index is at the end of the list, return the size
            if(idx == size){
                return size;
            }
            //return the index that's one after the current count
            return idx++;
        }
        ...
        public int previousIndex(){
            ...
            //If index is at the start of list, return -1
            if(idx == 0){
                return -1; 
            }
            //return the index that's one before the current count
            return idx-1;
        ...
        public void set(E element){
            ...
            //if statemenets that check whether you set it before or after
            if(forward != false && canRemoveOrSet == true){
                left.data = element; 
            } else
            if(forward == false && canRemoveOrSet == true){
                right.data = element;
            } else
             //throw if neither is the case
        ...
        public void remove(){
            ...
            /* if statement that removes and updates if next() 
            was called */
            if(forward != false && canRemoveOrSet == true){
            ...
            /*if statement that removes and updates if previous() was
            called */
            if(forward == false && canRemoveOrSet == true){
        ...
        //distanceToElement method
        public int distanceToElement(E element){
            ...
            //Create a counter and a Node to use as a reference
            int counter = 1;
            Node tracker = right;
            /*Loop through and check if data is present
            * Return the number of calls if it is 
            */ 
            for(int i = idx; i < size; i++){
            
                if(element == tracker.data) {
                    return counter;
